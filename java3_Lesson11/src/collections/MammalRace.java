...
public class MammalRace {
  ...
  public void race() {
    ...
    for(Mammal each : critters) {
      System.out.println("Name: " + each.getName() + " Speed: " + each.getSpeed() + " mph");
    }
    ...
    System.out.println("\nSorted from shortest to tallest, " + "with height information:");
    for(Mammal each : critters) {
      System.out.println("Name: " + each.getName() + " Height: " + each.getHeight() + " m");
    }
  }
}
